...
char *serializaJogador(int idAcao, Jogador *jogador)
{
	char *buffer = (char*)malloc(sizeof(char)*tam_total);
...
Jogador *desserializaJogador(char *buffer)
{
	//printf("Desseriando o jogador ");
