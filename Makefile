...
servidor: util.o listas.o colisao.o interface.o servidor.c
	gcc $(FLAGS) util.o listas.o colisao.o interface.o servidor.c -o servidor -lallegro -lallegro_primitives -lallegro_image -lallegro_font -lallegro_ttf -lm -lpthread
